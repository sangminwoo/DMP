...
def main():
    ref_batch = "/home/ubuntu/hyojun_mtl/ffhq_exp/CILABS-CVPR/evaluation/reference_batch.npz"
    root_dir = "/home/ubuntu/hyojun_mtl/ffhq_exp/CILABS-CVPR/samples/FFHQ/cosine_scheduling"
    init_methods=["similar", "quad", "cubic", "quart", "penta", "random", "sqrt"]
    sharing_ratio=0.6
    loss_weight_type="constant"
    model_name="DiT-B-2"
    file_name = "0100000-size-256-vae-ema-samples-50000-seed-0.npz"
    ...
    for init_method in init_methods:
        sample_batch=os.path.join(root_dir, f"{init_method}_{sharing_ratio}_{loss_weight_type}", model_name, file_name)
        ...
        import yaml
        with open(init_method + ".csv", 'w') as f:
            result_dict = {
                'name': init_method,
                'ref_batch': ref_batch,
