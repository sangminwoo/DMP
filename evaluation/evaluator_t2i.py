...
if __name__ == '__main__':
    ...
    parser.add_argument("--ref_stat_path", type=str, required=True)
    parser.add_argument("--sample_path", type=str, required=True)
    args = parser.parse_args()
    fid = calculate_fid_given_paths((args.ref_stat_path, args.sample_path))
    print(f'fid={fid}')

# CUDA_VISIBLE_DEVICES=5 python evaluation/evaluator_t2i.py --ref_stat_path '/home/sangmin/drive1/code/CILABS-CVPR/fid_stats_mscoco256_val.npz' --sample_path '/home/sangmin/drive1/code/CILABS-CVPR/samples/DiT_t2i-B-2-0400000-size-256-vae-ema-cfg-1.5-seed-0/'